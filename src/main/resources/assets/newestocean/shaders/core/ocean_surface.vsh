...
void main() {
    ...
    if (OceanWaveCount > 0.5) accumulateWave(OceanWaveA0, OceanWaveB0, worldXZ, height, displacement, slope);
    if (OceanWaveCount > 1.5) accumulateWave(OceanWaveA1, OceanWaveB1, worldXZ, height, displacement, slope);
    if (OceanWaveCount > 2.5) accumulateWave(OceanWaveA2, OceanWaveB2, worldXZ, height, displacement, slope);
    if (OceanWaveCount > 3.5) accumulateWave(OceanWaveA3, OceanWaveB3, worldXZ, height, displacement, slope);
    if (OceanWaveCount > 4.5) accumulateWave(OceanWaveA4, OceanWaveB4, worldXZ, height, displacement, slope);
    if (OceanWaveCount > 5.5) accumulateWave(OceanWaveA5, OceanWaveB5, worldXZ, height, displacement, slope);
